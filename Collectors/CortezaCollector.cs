...
public class CortezaCollector(IHttpClientFactory httpClientFactory) : IVersionCollector
{
    public string ProductName => "Corteza";
    ...
    public async Task<IReadOnlyCollection<CollectedVersion>> CollectAsync()
    {
        ...
        var url = "https://api.github.com/repos/cortezaproject/corteza/releases?per_page=50";
